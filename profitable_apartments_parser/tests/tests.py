...
def test_parser_get_url():
    valid_url = (
        "https://www.cian.ru/cat.php?currency=2&deal_type=sale&engine_version=2&maxprice=20000000&"
...
def test_parser_geolocate():
    ...
    print(res)
    assert res == [
        {"address": "Москва, башня Федерация", "coordinates": [55.749618, 37.537371]}
    ]
